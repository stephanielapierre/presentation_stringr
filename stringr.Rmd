...
La fonction `str_pad` permet d'ajouter des espaces supplémentaires à gauche, à droite ou des deux côtés dans une chaîne de caractères.
...
La fonction `str_locate` permet d'obtenir la position des caractères qui répondent à l'expression régulière testée.
```{r eval=TRUE}
x <- c("mercure", "vénus", "terre", "mars", "jupiter", "saturne", "uranus", "neptune", "why")
